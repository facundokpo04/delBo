...
selHotel = function (idHotel) {
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.estado) {
                debugger;
                $('#mNombre').val(res.response.hotel_nombre);
                $('#mDireccion').val(res.response.hotel_direccion);
                $('#mTelefono').val(res.response.hotel_telefono);

                $('#mEstado').val(res.response.hotel_estado);
                $('#mIdHotel').val(res.response.hotel_id);
            } else {
