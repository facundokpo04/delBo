...
selCategoria = function(idCategorias) {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (res.estado) {
                debugger;
                $('#mDescripcion').val(res.response.data.cat_descripcion);
                $('#mNombre').val(res.response.data.cat_nombre);
                $('#mEstado').val(res.response.data.cat_idEstado);
                $('#mEstadoVisible').val(res.response.data.cat_idEstadoVisible);
                $('#imgCategoria').val(res.response.data.cat_imagen),
                    //select
                    //ajax para traer todos los estados
                    $('#imagen').attr('src', './assets/imagenes/categoria/' + res.response.data.cat_imagen);
                $('#mIdCategoria').val(res.response.data.cat_id);
            } else {
