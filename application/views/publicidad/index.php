...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="btn-group"> 
            <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalEditPublicidad" >Agregar</button>
        </div>
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
                <table  id="tblPublicidad" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Nombre</th>
...
<div class="example-modal modal fade" id="modalEditPublicidad" tabindex="-1" >
    <div class="modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Agregar/ Eliminar Publicidades</h4>
                </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="datostab">
                                <form class="form-horizontal">
                                    <!-- parametros ocultos -->
                                    <input type="hidden" id="mIdPublicidad">
                                    <input type="hidden" id="imgPublicidad">

                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Nombre Publicidad</label>
                                            <div class="col-sm-9"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9"> 
                                                <div class="input-group">
                                                    <span class="input-group-addon cajaParametro"><i class="fa  fa-plus-circle fa-fw"></i> 
                                                    </span><input class="form-control" placeholder="" name="mtxtOrden" id="mOrden" type="number" autocomplete="on" autofocus="" tabindex="4" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="media-body">
                                    <div class="panel panel-bluedark">
                                        ...
                                        <div class="col-lg-12 form-group">
                                            <label for="">Imagen Publicidad</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" id="mbtnUpdPublicidad">Actualizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
